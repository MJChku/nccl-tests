...
# TARGET_MPI_ONE := $(PWD)/build/all_reduce_perf -b 8 -e 512 -f 2 -g 1
...
IB_LIB_PATH="/home/jiacma/nex-dist/src/sims/ib/rdma-core/build/lib"
...
# COMMAND1 := 'PORT=$$((12340 + $$OMPI_COMM_WORLD_RANK)); export NEX_ID=0; \
#             echo "Rank $$OMPI_COMM_WORLD_RANK listening on port $$PORT"; \
#             exec gdbserver :$$PORT /usr/local/bin/nex ./$(TARGET_MPI_ONE)'

# COMMAND2 := 'PORT=$$((12340 + $$OMPI_COMM_WORLD_RANK)); export NEX_ID=1; \
#             echo "Rank $$OMPI_COMM_WORLD_RANK listening on port $$PORT"; \
#             exec gdbserver :$$PORT /usr/local/bin/nex ./$(TARGET_MPI_ONE)'
